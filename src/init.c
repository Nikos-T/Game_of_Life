...
void gosper_glider_gun (int *board, int N, int nodeID) {
  switch (nodeID) {
    case 0:
      int i={1, 1, 2, 2, 9, 9, 10, 10, 11, 11, 17, 17, 17, 18, 19, 23, 23};
      int j={11, 12, 11, 12, 12, 13, 11, 13, 11, 12, 13, 14, 15, 13, 14, 10, 11};
      for (int k=0; k<17; k++) {
        Board(i[k], j[k])=1;
      }
    case 1:
      int i={0, 0, 1, 1, 1, 1, 2, 2, 11, 11, 12, 12, 12, 12, 12, 13, 14};
      int j={9, 11, 9, 10, 21, 22, 21, 23, 21, 9, 10, 9, 10, 16, 18, 16, 17};
      for (int k=0; k<17; k++) {
        Board(i[k], j[k])=1;
      }
  }
